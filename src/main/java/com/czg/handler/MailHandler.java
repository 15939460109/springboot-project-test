...
public class MailHandler {
    ...
    public void send() {
        ...
        message.setSubject("一个问候");
        message.setText("hello 哈喽");

        message.setTo("15939460109@163.com");
        message.setFrom("2357367330@qq.com");
    ...
    public void sendByTemplate() throws MessagingException {
        ...
        // 添加附件
        String filePath = "F:\\java二\\文件下载.txt";
        FileSystemResource fileSystemResource = new FileSystemResource(filePath);
        helper.addAttachment("学习资料.txt", fileSystemResource);
